  ...
  return h(
    ...
    h(
      ...
      h(
        ...
        h("h1", { className: "hero-home-title", style: { fontSize: "clamp(1.9rem, 2.8vw, 3.05rem)", lineHeight: "1.1", letterSpacing: "-0.018em", maxWidth: "14ch" } }, "Order local Korean groceries, specialty pantry staples, and family meals from trusted Calgary sellers."),
        h(
          "p",
          { className: "hero-text" },
